import { copyTrackMix, normalizeMasterMix } from './track-mix.mjs';
...
export function createSongPayload({ bpm, steps, drums = {}, pianoNotes = [], customTracks = [], trackMix = {}, masterMix = {} }) {
  ...
  return {
    ...
    masterMix: normalizeMasterMix(masterMix),
  };
}
